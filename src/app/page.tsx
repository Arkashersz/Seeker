    ...
    <>
      <MaxWidthWrapper className="mb-12 mt-28 sm:mt-40 flex flex-col items-center justify-center text-center">
        ...
        <h1 className="max-w-4xl text-5xl font-bold md:text-6xl lg:text-7xl">
          Converse com os seus <span className="text-blue-600">arquivos</span>{" "}
          em segundos.
        </h1>
        <p className="mt-5 max-w-prose text-zinc-700 sm:text-lg">
          O Seeker permite que você interaja com qualquer arquivo PDF. Basta
        ...
        <div className="mb-12 px-6 lg:px-8">
          <div className="mx-auto max-w-2xl sm:text-center">
            ...
            <p className="mt-4 text-lg text-gray-600">
              Interagir com seus arquivos em PDF nunca foi tão fácil como com o
              Seeker.
            </p>
          </div>
        </div>
        ...
        <ol className="my-8 space-y-4 pt-8 md:flex md:space-x-12 md:space-y-0">
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-medium text-blue-600">Etapa 1</span>
          ...
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-medium text-blue-600">Etapa 2</span>
              <span className="text-xl font-semibold">
                Faça upload do seu PDF
              </span>
              <span className="mt-2 text-zinc-700">
                O processamento do seu arquivo será feito para que você possa
                interagir com ele.
              </span>
            </div>
          </li>
          <li className="md:flex-1">
            <div className="flex flex-col space-y-2 border-1-4 border-zinc-300 py-2 pl-4 md:border-l-0 md:border-t-2 md:pb-0 md:pl-0 md:pt-4">
              <span className="text-sm font-medium text-blue-600">Etapa 3</span>
              <span className="text-xl font-semibold">Comece a interagir</span>
              <span className="mt-2 text-zinc-700">
                Experimente o Seeker hoje mesmo e leve menos de um minuto para
                aproveitar.
              </span>
            </div>
          </li>
